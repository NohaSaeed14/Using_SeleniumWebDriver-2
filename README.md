...
Using-SeleniumWebDriver-2 This is a Selenium WebDriver project to show how to make testcases for excepted result or to reach acceptance criteria. Here this is a project on Google Play Store (to assert Apps Page Title and Assert Education Category Page Title) with some assertions using maven project with dependencies and using Page Object Design pattern (for every page make a class and for testcases make testng class) and put some testng annotations to handle running for test cases.
...
-Also, put some import in classes like (selenium.WebDriver ,testng.annotations.AfterMethod , testng.annotations.BeforeMethod ,testng.annotations.Test , java.time.Duration ,java.util.concurrent.TimeUnit and selenium.support.ui.WebDriverWait).
...
Project Link : https://github.com/NohaSaeed14/Using_SeleniumWebDriver-2
